...
func GetParams(c *context.Context, r *http.Request) types.RouteParams {
...
func GetSession(c *context.Context, r *http.Request) *context.Session {
	...
	return context.NewSession(util.UUID(), []byte(conf.Session.Secret), abspath)
}
...
func GetRenderCtx(c *context.Context, r *http.Request) types.RenderCtx {
	rnd := GetRenderer(c, r)
